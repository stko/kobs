...
SetOutPath $INSTDIR
File /r  /x .svn "zbar"
#File /r  /x .svn "client/java/interface/qrcode/lib"
File /r  /x .svn "client/java/interface/qrcode/QRCodeReader.*"
...
CreateShortCut "$SMPROGRAMS\KLOBS\QRCode Reader.lnk" "$INSTDIR\qrcode.bat"
